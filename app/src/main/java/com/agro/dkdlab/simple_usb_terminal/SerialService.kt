...
class SerialService : Service(), SerialListener {
    ...
    fun write(data: ByteArray?) {
        ...
        socket!!.write(data)
        data?.let{
            Log.e("write", "serial service: ${String(data)}")
        }
    }
    ...
    private fun createNotification() {
        ...
        val builder = NotificationCompat.Builder(this, Constant.NOTIFICATION_CHANNEL)
            .setSmallIcon(R.drawable.ic_notification)
            .setColor(findColor(R.color.colorPrimary))
